...
class PrototypicalNetwork(nn.Module):
    ...
    def _compute_prototypes_embedding(self, input_batch: ProtoNetBatch) -> torch.Tensor:
        support_features: List[torch.Tensor] = []
        query_features: List[torch.Tensor] = []
        ...
        features_flat = torch.cat([support_features_flat, query_features_flat], dim=0)

        return support_features_flat, query_features_flat