...
def read_esm_embedding(fs_mol_dataset_path: str, esm2_model: str = "esm2_t33_650M_UR50D", layer: int = 33) -> Tuple[torch.Tensor, torch.Tensor, torch.Tensor, List, List, List]:
    ...
    return train_emb_tensor, valid_emb_tensor, test_emb_tensor, train_emb_label, valid_emb_label, test_emb_label